...
<div x-data="{ 
    ...
    <div class="flex-1">
        ...
        <template x-if="type === 'success'">
            <div class="mt-3">
                <a href="{{ route('client.cart.index') }}" class="text-[10px] font-bold uppercase tracking-widest text-white bg-slate-900 px-3 py-1.5 rounded hover:bg-emerald-600 transition-colors inline-flex items-center gap-1">
