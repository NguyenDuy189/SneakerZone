...
<div class="container px-6 mx-auto mb-20 fade-in">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center my-6 gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-slate-800">Tạo mã giảm giá</h2>
                <p class="text-sm text-slate-500 mt-1">Thiết lập chương trình khuyến mãi mới</p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input type="text" name="code" id="code" value="{{ old('code') }}" 
                                    class="uppercase pl-4 pr-32 py-3 w-full border border-slate-200 rounded-xl text-sm font-bold text-slate-700 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 shadow-sm"
                                    placeholder="VD: SALE50, TET2025...">
                                
                                <button type="button" onclick="generateCode()" class="absolute right-2 text-xs bg-slate-100 hover:bg-slate-200 text-slate-600 font-bold py-1.5 px-3 rounded-lg transition-colors border border-slate-200">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" 
                                ...
                                placeholder="Ví dụ: Giảm giá nhân dịp khai trương...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="cursor-pointer">
                                    <input type="radio" name="type" value="fixed" class="peer sr-only" onchange="toggleType()" {{ old('type', 'fixed') == 'fixed' ? 'checked' : '' }}>
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" name="type" value="percentage" class="peer sr-only" onchange="toggleType()" {{ old('type') == 'percentage' ? 'checked' : '' }}>
                                    <div class="p-4 rounded-xl border border-slate-200 hover:border-indigo-500 peer-checked:border-indigo-600 peer-checked:bg-indigo-50 transition-all text-center">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="value" id="valueInput" value="{{ old('value') }}" 
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="max_usage" value="{{ old('max_usage') }}" 
                                class="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 shadow-sm text-slate-600"
                                placeholder="VD: 100">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    {{-- Nút Lưu: Dùng màu đen (slate-900) đồng bộ --}}
