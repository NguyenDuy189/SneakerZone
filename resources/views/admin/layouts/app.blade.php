                ...
                <nav class="space-y-1 px-3">
                    ...
                    <div x-data="{ open: {{ request()->routeIs('admin.products.*', 'admin.categories.*', 'admin.brands.*', 'admin.attributes.*', 'admin.reviews.*') ? 'true' : 'false' }} }">
                        <button @click="open = !open" 
                            ...
                            <div class="flex items-center">
                                <i class="fa-solid fa-box-open w-6 h-6 flex items-center justify-center text-lg {{ request()->routeIs('admin.products.*', 'admin.categories.*') ? 'text-indigo-400' : '' }}"></i>
                                <span x-show="sidebarOpen" class="ml-3 truncate">Kho sản phẩm</span>
                            </div>
                    ...
                    <div x-data="{ open: {{ request()->routeIs('admin.flash_sales.*', 'admin.banners.*', 'admin.discounts.*') ? 'true' : 'false' }} }">
                        <button @click="open = !open" 
                            ...
                            <div class="flex items-center">
                                <i class="fa-solid fa-bullhorn w-6 h-6 flex items-center justify-center text-lg {{ request()->routeIs('admin.flash_sales.*', 'admin.banners.*', 'admin.discounts.*') ? 'text-indigo-400' : '' }}"></i>
            ...
            <header class="bg-white shadow-sm h-16 flex items-center justify-between px-6 z-20 sticky top-0">
                ...
                <div class="flex items-center gap-4">
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" x-cloak class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-slate-100 py-1 z-50">
