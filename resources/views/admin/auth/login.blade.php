...
<head>
    ...
    <title>Đăng nhập Quản trị - Sneaker Zone</title>
...
<body class="bg-slate-900 h-screen flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1556906781-9a412961c28c?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center">
    ...
    <div class="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden p-8 m-4">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 text-sm mt-1">Đăng nhập hệ thống quản trị</p>
        </div>
        ...
        <form action="{{ route('admin.login.submit') }}" method="POST" class="space-y-5">
            ...
            <div class="flex items-center justify-between">
                ...
                {{-- Lưu ý: Bạn cần tạo route 'admin.password.request' hoặc đổi href="#" --}}
                <a href="{{ route('admin.password.request') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-500 hover:underline">
                    Quên mật khẩu?
                </a>
            </div>
