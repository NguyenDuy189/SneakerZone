...
Route::name('client.')->group(function () {
    ...
    Route::prefix('shop')->name('products.')->group(function() {
        ...
        // nam,nữ,sale
        Route::get('/nam', [ClientProductController::class, 'getProductsByGender'])->name('men');
        Route::get('/nu', [ClientProductController::class, 'getProductsByGender'])->name('women');
        Route::get('/sale', [ClientProductController::class, 'getSaleProducts'])->name('sale');
        Route::get('/{slug}', [ClientProductController::class, 'show'])->name('show');
    });

    // 3. Đánh giá (Review) - Bắt buộc đăng nhập và giỏ hàng
    Route::middleware('auth')->group(function() {
        ...
        Route::group(['prefix' => 'cart', 'as' => 'cart.'], function () { 
            ...
            // Thêm dòng này để sửa lỗi Route [client.cart.checkout] not defined
    ...
    //8. --- CÁC TRANG TĨNH (FOOTER) ---
    Route::controller(PageController::class)->group(function () {
        Route::get('/ve-chung-toi', 'about')->name('about');
        Route::get('/lien-he', 'contact')->name('contact');
        Route::get('/he-thong-cua-hang', 'stores')->name('stores');
        Route::get('/tin-tuc', 'blog')->name('blog');
...
//9.dki email để nhận mã giảm giá
    Route::post('/subscribe-newsletter', [SubscriberController::class, 'subscribe'])->name('subscribe');
